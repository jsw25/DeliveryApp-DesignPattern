package BulGogiBurger;

import IngrediementsOfBurgerStore.IngrediementsOfBurgerStore;
import SingleBurger.BulGogiBurger;

public class BulGogiBurger_맘스터치 extends BulGogiBurger {

    // 이거는 각 종 피자에 속했으며, pizzaIngrediementFactory에서 제공했음..
    IngrediementsOfBurgerStore ingrediementsOfBurgerStore;

    public BulGogiBurger_맘스터치(IngrediementsOfBurgerStore ingrediementsOfBurgerStore) {
